...
*
        WRITE(IPS,300)
 300    FORMAT(//2X,'COORDENADAS DOS PONTOS EXTREMOS DOS ELEMENTOS DA MA
     $LHA'//4X,'PONTO',10X,'X',18X,'Y',18X,'Z')
...
*
 ...
 600    FORMAT(//2X,'CONDIÇÕES DE CONTORNO'//8X,3('VALOR PRESCRITO',10X)
     $      /1X,'ELEM',6X,'DIREÇÃO X',4X,'CÓDIGO',6X,'DIREÇÃO Y',4X,
     $      'CÓDIGO',6X,'DIREÇÃO Z',4X,'CÓDIGO')
        DO 20 I=1,NBE
