...
for i in {1..1}; do
	...
	optirun --no-xorg ./main > "results/parallel_240_$i.txt"

done

for i in {1..1}; do
	echo "Executando em paralelo com 960: $i"
	optirun --no-xorg ./main ESOLO960E_-5+5_e10.DAT ESOLO960D_-5+5_e10.DAT SSOLO960E_-5+5_e10.DAT SSOLO960D_-5+5_e10.DAT > "results/parallel_960_$i.txt"
done
for i in {1..1}; do
	echo "Executando em paralelo com 2160: $i"
	optirun --no-xorg ./main ESOLO2160E_-5+5.DAT ESOLO2160D_-5+5.DAT SSOLO2160E_-5+5.DAT SSOLO2160D_-5+5.DAT > "results/parallel_2160_$i.txt"
done
for i in {1..1}; do
	echo "Executando em paralelo com 4000: $i"
	optirun --no-xorg ./main ESOLO4000E_-20+20.DAT ESOLO4000D_-20+20.DAT SSOLO4000E_-20+20.DAT SSOLO4000D_-20+20.DAT > "results/parallel_4000_$i.txt"
done
