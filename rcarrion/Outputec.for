...
*                                                                      *
*              FORÇAS DE SUPERFÍCIE NOS NÓS DO CONTORNO                *
*                                                                      *
************************************************************************
*
...
*
        WRITE(IPS,700),FR
 700    FORMAT(30X,'FREQÜÊNCIA = ',D14.7/)
*
        WRITE(IPS,100)
 100    FORMAT(' ',79('*')//1X,'RESULTADOS'//2X,'NÓS DO CONTORNO'//
     $    ' ELEM',
...
*
 ...
 350            FORMAT(I4,9(2X,D11.4,',',D11.4))
  25        CONTINUE
            WRITE(IPT,*)FR,ABS(ZFI(157)),ABS(ZFI(166))
        ENDIF
