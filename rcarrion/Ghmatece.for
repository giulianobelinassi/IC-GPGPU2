...
* ACIONA ROTINA QUE CALCULA OS COEFICIENTES DE H E G NÃO SINGULAR
                    CALL NONSINGE(HELEM,GELEM,CO,CXM(I),
     $                  CYM(I),CZM(I),ETA,N,NP,NPG,GE,
     $                  RNU,RMU,C1,C2,C3,C4,DELTA
     $              )
                ELSE
* ACIONA ROTINA QUE CALCULA OS COEFICIENTES DE G SINGULAR
                    CALL SINGGE(HELEM,GELEM,CXM(I),CYM(I),
     $                  CZM(I),ETA,CX,CY,CZ,N1,N2,N3,N4,NCOX,
