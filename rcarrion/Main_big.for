...
C       PARAMETER (NE=960,NX=3*NE,NCOX=962,NPIX=10,NFRX=7)
        PARAMETER (NE=14400,NX=3*NE,NCOX=14402,NPIX=10,NFRX=7)
...
C       OPEN(UNIT=IPS,FILE='SSOLO240D_-5+5.DAT',STATUS='UNKNOWN')
        ...
        OPEN(UNIT=INP,FILE='ESOLO14400E_-5+5.DAT',STATUS='OLD')
        OPEN(UNIT=INQ,FILE='ESOLO14400D_-5+5.DAT',STATUS='OLD')
        OPEN(UNIT=IPR,FILE='SSOLO14400E_-5+5.DAT',STATUS='UNKNOWN')
        OPEN(UNIT=IPS,FILE='SSOLO14400D_-5+5.DAT',STATUS='UNKNOWN')
