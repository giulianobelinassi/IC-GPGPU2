...
*
        ...
        DIMENSION ZDFI(NX),ZFI(NX),ZVETSOL(NX),ZDSOL(3*NPIX)
...
C       OPEN(UNIT=INP,FILE='ESOLO240E_-5+5_e10.DAT',STATUS='OLD')
C       OPEN(UNIT=INQ,FILE='ESOLO240D_-5+5_e10.DAT',STATUS='OLD')
C       OPEN(UNIT=IPR,FILE='SSOLO240E_-5+5_e10.DAT',STATUS='UNKNOWN')
C       OPEN(UNIT=IPS,FILE='SSOLO240D_-5+5_e10.DAT',STATUS='UNKNOWN')
...
*
        CALL INTEREC(ZFI,ZDFI,KODE,CX,CY,CZ,CXI,CYI,CZI,ZDSOL,ZSSOL,NE,
     $      NX,NCOX,NPIX,CONE,ZGE,ZCS,ZCP,DELTA,PI,FR,NPG,L,N,NBE,RHO)
*
