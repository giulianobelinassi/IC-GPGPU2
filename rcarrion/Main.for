...
C        OPEN(UNIT=IPS,FILE='SSOLO2160D_-5+5.DAT',STATUS='UNKNOWN')
        ...
        OPEN(UNIT=INP,FILE='ESOLO4000E_-20+20.DAT',STATUS='OLD')
        OPEN(UNIT=INQ,FILE='ESOLO4000D_-20+20.DAT',STATUS='OLD')
        OPEN(UNIT=IPR,FILE='SSOLO4000E_-20+20.DAT',STATUS='UNKNOWN')
        OPEN(UNIT=IPS,FILE='SSOLO4000D_-20+20.DAT',STATUS='UNKNOWN')
